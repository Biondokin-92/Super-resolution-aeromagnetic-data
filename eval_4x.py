...
parser.add_argument('--data_dir', type=str, default='/content/drive/MyDrive/rcan-tensorflow/TTST-main/AID-tiny/Train/LR')

parser.add_argument('--model_type', type=str, default='rcan')
parser.add_argument('--pretrained_sr', default='/content/drive/MyDrive/rcan-tensorflow/saved_models/ttst/19-23-08/ttst_epoch_9.pth', help='sr pretrained base model')
parser.add_argument('--save_folder', default='/content/drive/MyDrive/rcan-tensorflow/output/images_Rcan/SR_RCAN', help='Location to save checkpoint models')
...
if __name__ == '__main__':
    AID_class_name = ['/content/drive/MyDrive/rcan-tensorflow/TTST-main/AID-tiny/LR']
    dota_class = ['']
